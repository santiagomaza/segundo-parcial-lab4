...
if archivo_csv:
    ...
    for producto in productos:      
        ...
        df_grouped['Variacion_Margen_Promedio'] = df_grouped['Margen_promedio'].pct_change().mean() * 100
        df_grouped['Variacion_Unidades_Vendidas'] = df_grouped['Unidades_vendidas'].pct_change().mean() * 100
